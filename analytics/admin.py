...
class TrackingSourceDetailsDailyAdmin(ImportExportModelAdmin):
    list_display = ['get_tracking_source_tracking_id','get_tracking_source_name','page_url','page_views','page_clicks','day' ,'web_browser','creation_time', 'deletion_time', 'is_active']
    list_filter = ['tracking_source__tracking_id','tracking_source__name','page_url','page_views','page_clicks','day','web_browser','creation_time', 'deletion_time', 'is_active']
    search_fields = ['tracking_source__tracking_id','tracking_source__name','page_url','page_views','page_clicks','day','web_browser','creation_time', 'deletion_time', 'is_active']
...
class TrackingSourceDetailsMonthlyAdmin(ImportExportModelAdmin):
    list_display = ['get_tracking_source_tracking_id','get_tracking_source_name','page_url','page_views','page_clicks','web_browser','creation_time', 'month' ,'deletion_time', 'is_active']
    list_filter = ['tracking_source__tracking_id','tracking_source__name','page_url','page_views','page_clicks','web_browser','creation_time', 'month','deletion_time', 'is_active']
    search_fields = ['tracking_source__tracking_id','tracking_source__name','page_url','page_views','page_clicks','web_browser','creation_time', 'month' ,'deletion_time', 'is_active']
